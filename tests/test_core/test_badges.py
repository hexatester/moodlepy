...
class TestBadges:
    def test_get_user_badges(self, moodle: Moodle):
        ...
        for badge in badges:
            ...
            assert not badge.timemodified or isinstance(badge.timemodified, int)
            assert not badge.usercreated or isinstance(badge.usercreated, int)
            assert not badge.usermodified or isinstance(badge.usermodified, int)
            ...
            assert not badge.expireperiod or isinstance(badge.expireperiod, int)
            ...
            assert not badge.messagesubject or isinstance(badge.messagesubject, str)
            assert not badge.attachment or isinstance(badge.attachment, int)
            assert not badge.notification or isinstance(badge.notification, int)
            ...
            assert not badge.imageauthorname or isinstance(badge.imageauthorname, str)
            assert not badge.imageauthoremail or isinstance(badge.imageauthoremail, str)
            assert not badge.imageauthorurl or isinstance(badge.imageauthorurl, str)
            assert not badge.imagecaption or isinstance(badge.imagecaption, str)
            assert isinstance(badge.badgeurl, str)
            assert not badge.endorsement or isinstance(
                badge.endorsement, BagdeEndorsement
            )
            for alignment in badge.alignment:
                ...
                assert not alignment.badgeid or isinstance(alignment.badgeid, int)
                assert not alignment.targetName or isinstance(alignment.targetName, str)
                assert not alignment.targetUrl or isinstance(alignment.targetUrl, str)
                ...
                assert not alignment.targetCode or isinstance(alignment.targetCode, str)
            for related_badge in badge.relatedbadges:
                ...
                assert not related_badge.type or isinstance(related_badge.type, int)
